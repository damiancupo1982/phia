...
// Incluye autos, botes y jetski con todos los campos completos.
...
export const initialInventory = [
  ...
  // 🔥 NUEVOS AUTOS DE LUJO (5) — ahora con fuel "Gasolina" y deposit 100
  { id: '26', name: 'Lamborghini Huracán',             type: 'Lux',         fuel: 'Gasolina', deposit: 100, lowSeasonPrice: 500, highSeasonPrice: 500, seats: 2 },
  { id: '27', name: 'Ferrari Portofino',               type: 'Lux',         fuel: 'Gasolina', deposit: 100, lowSeasonPrice: 550, highSeasonPrice: 550, seats: 2 },
  { id: '28', name: 'Rolls Royce Cullinan',            type: 'Lux',         fuel: 'Gasolina', deposit: 100, lowSeasonPrice: 800, highSeasonPrice: 800, seats: 4 },
  { id: '29', name: 'Bentley Continental GT',          type: 'Lux',         fuel: 'Gasolina', deposit: 100, lowSeasonPrice: 600, highSeasonPrice: 600, seats: 4 },
  { id: '30', name: 'Maserati Levante',                type: 'Lux',         fuel: 'Gasolina', deposit: 100, lowSeasonPrice: 400, highSeasonPrice: 400, seats: 5 },

  // 🚤 BOTES — ahora con fuel "Gasolina" y deposit 100
  { id: '31', name: 'Bote (2 horas)',                  type: 'Boat',        fuel: 'Gasolina', deposit: 100, lowSeasonPrice: 250, highSeasonPrice: 250 },
  ...
  { id: '33', name: 'Jet Ski (2 hora)',                type: 'JetSki',      fuel: 'Gasolina', deposit: 100, lowSeasonPrice: 350, highSeasonPrice: 350 }
];
